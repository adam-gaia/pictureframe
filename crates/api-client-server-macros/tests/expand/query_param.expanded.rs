...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl _serde::Serialize for ListUsersParams {
        fn serialize<__S>(
            &self,
            __serializer: __S,
        ) -> _serde::__private228::Result<__S::Ok, __S::Error>
...
const _: () = {
    ...
    extern crate serde as _serde;
    #[automatically_derived]
    impl<'de> _serde::Deserialize<'de> for ListUsersParams {
        fn deserialize<__D>(
            __deserializer: __D,
        ) -> _serde::__private228::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                ...
                {
                    match __value {
                        "page" => _serde::__private228::Ok(__Field::__field0),
                        "limit" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
                fn visit_bytes<__E>(
                ...
                {
                    match __value {
                        b"page" => _serde::__private228::Ok(__Field::__field0),
                        b"limit" => _serde::__private228::Ok(__Field::__field1),
                        _ => _serde::__private228::Ok(__Field::__ignore),
                    }
                }
            }
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private228::PhantomData<ListUsersParams>,
                lifetime: _serde::__private228::PhantomData<&'de ()>,
            }
            #[automatically_derived]
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                type Value = ListUsersParams;
                fn expecting(
                    &self,
                    __formatter: &mut _serde::__private228::Formatter,
                ) -> _serde::__private228::fmt::Result {
                    ...
                    __A: _serde::de::SeqAccess<'de>,
                {
                    ...
                    >(&mut __seq)? {
                        ...
                        _serde::__private228::None => {
                            return _serde::__private228::Err(
                                _serde::de::Error::invalid_length(
                                    0usize,
                                    &"struct ListUsersParams with 2 elements",
                                ),
                            );
                        }
                    };
                    ...
                    _serde::__private228::Ok(ListUsersParams {
                        page: __field0,
                        limit: __field1,
                    })
                }
                ...
                {
                    let mut __field0: _serde::__private228::Option<Option<u32>> = _serde::__private228::None;
                    let mut __field1: _serde::__private228::Option<Option<u32>> = _serde::__private228::None;
                    ...
                    let __field0 = match __field0 {
                        ...
                        _serde::__private228::None => {
                            _serde::__private228::de::missing_field("page")?
                        }
                    };
            ...
            #[doc(hidden)]
            const FIELDS: &'static [&'static str] = &["page", "limit"];
...
impl MyApp {
    pub async fn list_users(&self, params: ListUsersParams) -> MyResult<Vec<User>> {
        let _ = params;
...
impl MyApp {
    ...
    pub fn router(self: std::sync::Arc<Self>) -> axum::Router {
        axum::Router::new()
            .route("/users", axum::routing::get(__axum_handler_list_users))
            .with_state(self)
    }
}
async fn __axum_handler_list_users(
...
impl MyAppClient {
    ...
    pub async fn list_users(
    ...
    ) -> Result<Vec<User>, MyAppClientError> {
        let url = {
            ...
            if query_string.is_empty() {
                ...
                ::alloc::__export::must_use({
                    ::alloc::fmt::format(format_args!("{0}?{1}", base, query_string))
                })
            }
        };
        let response = self
        ...
        response.json::<Vec<User>>().await.map_err(MyAppClientError::Request)
    }
}
fn main() {}
